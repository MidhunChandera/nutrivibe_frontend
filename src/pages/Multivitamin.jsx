...
function Multivitamin() {
  ...
  const multiProducts = productdata.filter(product => product.category === 'multivitamin');
  useEffect(() => {
    let data = multiProducts;
  ...
  return (
      ...
      <div>
        <div style={{ minHeight: '100vh', backgroundColor: 'white' }}>
          <div className="container py-5" style={{ marginTop: '100px' }}>
            <h5 className="text-dark">Multivitamin</h5>
            <div className="row">
   ...
   <Dropdown className='mt-3'>
                         ...
                         <Dropdown.Menu className='w-100'>
                         <Dropdown.Item>
                             <input checked={weightfilter === "100g"}   onChange={() => setweightfilter("60 TABLET")} type="checkbox" className="me-2" />
                        60 TABLET
                           </Dropdown.Item>
                           <Dropdown.Item>
              ...
              <div className="col-12 col-md-9">
                <div className="row g-3">
                  {filteredProducts.length > 0 ? filteredProducts.map((product) => (
                    ...
                    <p>No Multivitamin products available</p>
                  )}

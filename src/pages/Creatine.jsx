...
function Whey() {
  ...
  useEffect(() => {
    if (productdata) {
      const CreatineProducts = productdata.filter(product => product.category === 'Creatine');
      let data = CreatineProducts;
  ...
  }, [productdata, brandFilter,weightfilter]);
    ...
    <Navbar/>
      <div style={{ minHeight: '100vh', backgroundColor: 'white' }}>
        <div className="container py-5" style={{ marginTop: '100px' }}>
          <h5 className="text-dark">Creatine</h5>
          <div className="row">
            ...
            <div className="col-12 col-md-9">
              <div className="row g-3">
                {filteredProducts.length > 0 ? filteredProducts.map((product) => (
                  ...
                  <p>No creatine protein products available</p>
                )}
              </div>
            </div>
          </div>
